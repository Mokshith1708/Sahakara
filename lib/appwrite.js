...
export const uploadFile = async (file, type) => {
  ...
  const storageId = (type === "blog") ? config.blogStorageId : config.itemStorageId;
...
export const createBlog = async ({
  ...
  try {
    const _blogURI = await uploadFile(photo, "blog");
...
export const createItem = async ({
  ...
  try {
    const itemURI = await uploadFile(photo, "item");
